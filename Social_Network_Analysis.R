# Including the following list of libraries for the project.
# 1. Shiny - for the shiny app.
# 2. networkD3 - for plotting the social network.
# 3. igraph - for graph analysis of the network.
# 4. vizNetwork - for visualizing the network.
...
ui <- fluidPage(
        ...
        sidebarLayout(
            ...
            mainPanel(
                tabsetPanel(id = "tab",
                    # Frist tab to show the data in tabular form
